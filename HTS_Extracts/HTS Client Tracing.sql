...
FROM kenyaemr_etl.etl_hts_test ht
         INNER JOIN kenyaemr_etl.etl_patient_demographics d ON ht.patient_id = d.patient_id
         INNER JOIN kenyaemr_etl.etl_hts_referral_and_linkage htsrl ON ht.patient_id = htsrl.patient_id
