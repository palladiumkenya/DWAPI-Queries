select a.patient_id                                                   as PatientPK,
       ...
       concat_ws(',', NULLIF(if(a.orientation = 'Yes', 'OTZ Orientation', null), ''),
           ...
           , NULLIF(if(a.transition_to_adult_care = 'Yes', 'OTZ Transition to Adult care', ''), ''),
                 ...
                 NULLIF(if(a.srh = 'Yes', 'OTZ SRH', ''), ''), NULLIF(if(a.leadership = 'Yes', 'Leadership', ''), ''),
                 NULLIF(if(a.beyond_third_ninety = 'Yes', 'OTZ Beyond the 3rd 90', null),
                        ''))                                          as ModulesCompletedToday,
       a.attended_support_group                                       as SupportGroupInvolvement,
       a.remarks                                                      as Remarks,
       d.attrition_reason                                             as TransitionAttritionReason,
       d.Outcome_date                                                 as OutcomeDate,
       a.date_created                                                 as Date_Created,
       if(greatest(IFNULL(e.date_last_modified, '0000-00-00'), IFNULL(a.date_last_modified, '0000-00-00'),
                   IFNULL(d.date_last_modified, '0000-00-00')) = '0000-00-00',
          NULL, greatest(IFNULL(e.date_last_modified, '0000-00-00'), IFNULL(a.date_last_modified, '0000-00-00'),
                         IFNULL(d.date_last_modified, '0000-00-00'))) as Date_Last_Modified,
       a.voided                                                       as voided
from dwapi_etl.etl_otz_activity a
         ...
         left join (select d.patient_id,
                    ...
                    group by d.patient_id) d on d.patient_id = a.patient_id
