select d.openmrs_id                                                                         PatientPK,
       ...
       f.missed_appointment_date                                                         as DateMissedAppointment,
       (case f.tracing_type
       ...
       (case f.reason_not_contacted
            ...
            when 5622 then 'Other' end)                                                  as ReasonNotContacted,
       ...
       (case f.true_status
           ...
           when 142917 then 'Other' end)                                    as TrueStatus,
       (case f.reason_for_missed_appointment
            ...
            when 5622
                then concat_ws('-', 'Other', f.non_coded_missed_appointment_reason) end) as ReasonForMissedAppointment,
