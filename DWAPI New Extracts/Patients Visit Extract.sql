select ''                                                                     AS SatelliteName,
       ...
       DATE(fup.visit_date)                                                   AS VisitDate,
       ...
       DATE(fup.last_menstrual_period)                                        as LMP,
       DATE(fup.expected_delivery_date)                                       as EDD,
       t.height                                                               as Height,
       t.weight                                                               as Weight,
       ...
       DATE(fup.next_appointment_date)                                        AS NextAppointmentDate,
       'KenyaEMR'                                                             as Emr,
       'Kenya HMIS II'                                                        as Project,
       DATE(fup.substitution_first_line_regimen_date)                         AS SubstitutionFirstlineRegimenDate,
       fup.substitution_first_line_regimen_reason                             AS SubstitutionFirstlineRegimenReason,
       DATE(fup.substitution_second_line_regimen_date)                        AS SubstitutionSecondlineRegimenDate,
       fup.substitution_second_line_regimen_reason                            AS SubstitutionSecondlineRegimenReason,
       DATE(fup.second_line_regimen_change_date)                              AS SecondlineRegimenChangeDate,
...
from kenyaemr_etl.etl_patient_demographics d
         ...
         left join (select t.patient_id,
                   ...
                   on fup.patient_id = t.patient_id and fup.visit_date = t.visit_date
